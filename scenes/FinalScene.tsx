...
export default function FinalScene({ replay }: { replay?: () => void }) {
  ...
  const message = encodeURIComponent('Hola FUXION, quisiera pedir los productos.');
  ...
  return <section id="habito" className="final-scene scene" aria-labelledby="final-title">
    ...
    <div className="final-action">
      <a
        ...
        className="wsp-final-btn"
        aria-label="Pídelos aquí por WhatsApp al +51972081522"
      >
        <svg viewBox="0 0 32 32" className="wsp-icon" aria-hidden="true" width="26" height="26" fill="currentColor">
